    ...
    >
      ...
      >
        ...
        <div className="min-w-0 flex-1 pl-2.5 pr-1">
          <h3 className="truncate text-[15px] font-bold leading-tight text-[#2a2348] transition-colors duration-300 dark:text-[#f2efff]">
            John Doe - Portal
          </h3>
          <p className="mt-0.5 line-clamp-2 text-[12px] leading-snug text-[#4a4568] transition-colors duration-300 dark:text-[#d4cff0]">
            Hey! Could you please review a document for me?
          </p>
          <p className="mt-0.5 text-[11px] text-[#6a6490] transition-colors duration-300 dark:text-[#b8b4d8]">
            MAT-2233 - 2 h ago
          </p>
        </div>
      </motion.div>
